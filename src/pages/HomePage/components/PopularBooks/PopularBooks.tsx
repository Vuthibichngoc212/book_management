...
// import { useStyles } from './PopularBooks.style';
...
const PopularBooks = () => {
	...
	const navigate = useNavigate();
	const { data: booksData, isLoading, isError } = useGetAllBooksQuery(undefined);
	const [showMore, setShowMore] = useState(false); // Trạng thái để hiển thị toàn bộ danh sách
	...
	const handleShowMore = () => {
		setShowMore(true); // Hiển thị toàn bộ danh sách sách khi nhấn
	};
